...
class TestTarget:
    ...
    def _create_target(self, col: TestCollection, **kwargs: Unpack[ConfiguredTargetDict]):
    ...
    def test_get_corpus_data_non_cached_config(self, col: TestCollection):
        # Setup
    ...
    @with_test_collection("empty_collection")
    def test_get_corpus_data_partial_maturity_config(self, col: TestCollection):
    ...
    @with_test_collection("empty_collection")
    def test_get_corpus_data_updates_on_config_change(self, col: TestCollection):
        # Setup
    ...
    @with_test_collection("empty_collection")
    def test_get_corpus_data_none_cached_updates_on_config_change(self, col: TestCollection):
        # Setup
        config_target, target = self._create_target(
            col,
            familiarity_sweetspot_point=0.5
