...
def test_item_str_list(cacher: Cacher) -> None:
...
def test_item_str(cacher: Cacher) -> None:
...
def test_item_dict(cacher: Cacher) -> None:
...
def test_different_items(cacher: Cacher) -> None:
