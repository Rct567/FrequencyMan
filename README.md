...
- `proper_introduction_dispersed`: Disperses cards using the `proper_introduction` factor. This is done per new word, thus dispersing cards with the same new word.
